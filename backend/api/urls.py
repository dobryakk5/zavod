...
from .views_public_client_page import (
    ...
    PublicClientPageStepHistoryView,
...
urlpatterns = [
    ...
    path('public/client-page/<int:client_id>/steps/<str:step_id>/history/', PublicClientPageStepHistoryView.as_view(), name='public-client-page-step-history'),
